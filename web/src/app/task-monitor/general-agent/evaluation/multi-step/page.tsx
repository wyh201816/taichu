...
export default function GeneralAgentMultiStepEvaluationPage() {
  return (
    <Suspense
      fallback={
        <main className="min-h-screen bg-[#202020] px-8 py-10 text-[#f4f4f4]">
          <p className="text-sm text-[#a7a7a7]">正在加载多步骤任务评测…</p>
        </main>
      }
    >
      <GeneralAgentEvaluationShell entryId="multi_step" />
    </Suspense>
  );
}
